...
<div class="mb-4">
    <a href="{{ route('prestamos.show', $prestamo) }}" class="text-muted" style="font-size:13px; text-decoration:none;">
        ← Volver al préstamo
    </a>
</div>
...
<div class="rounded-3 p-4 mb-4 d-flex align-items-start gap-3"
    ...
    <div>
        <p class="fw-medium mb-1" style="color:#e65100; font-size:14px;">
            Reestructuración de préstamo — {{ $prestamo->cliente->nombre_completo }}
        </p>
        <div class="d-flex gap-4" style="font-size:13px; color:#e65100;">
            <span>Saldo: <strong>${{ number_format($prestamo->saldo_restante, 2) }}</strong></span>
            <span>Mora: <strong>${{ number_format($prestamo->mora_acumulada, 2) }}</strong></span>
            <span>Días de atraso: <strong>{{ $diasAtraso }}</strong></span>
        </div>
    </div>
</div>

<form method="POST" action="{{ route('reestructuracion.store', $prestamo) }}" id="formReestructuracion">
    @csrf
    ...
    <div class="row g-4">
        ...
        <div class="col-12">
            <div class="bg-white border rounded-3 p-4" style="border-color:#e8e8e8 !important;">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        <label class="d-block p-3 rounded-3 h-100" style="border:0.5px solid #ddd; cursor:pointer;" id="card_condonacion">
                            <input type="radio" name="tipo" value="condonacion" class="me-2" onchange="mostrarOpcion('condonacion')">
                            ...
                            <p class="mb-0 mt-2" style="font-size:12px; color:#888;">
                                Se perdona un porcentaje de la mora acumulada para que el cliente pueda reanudar pagos más fácilmente.
                            </p>
                        </label>
                    </div>
                    ...
                    <div class="col-md-4">
                        <label class="d-block p-3 rounded-3 h-100" style="border:0.5px solid #ddd; cursor:pointer;" id="card_nuevo">
                            <input type="radio" name="tipo" value="nuevo_prestamo" class="me-2" onchange="mostrarOpcion('nuevo_prestamo')">
        ...
        <div class="col-12" id="opcion_condonacion" style="display:none;">
            <div class="bg-white border rounded-3 p-4" style="border-color:#e8e8e8 !important;">
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <div class="input-group input-group-sm">
                            <input type="number" name="porcentaje_condonacion" id="porcentaje_condonacion"
            ...
            <div class="bg-white border rounded-3 p-4" style="border-color:#e8e8e8 !important;">
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" value="{{ $prestamo->numero_periodos ?? '—' }}"
                    ...
                    <div class="col-12">
                        <div class="p-3 rounded-3" style="background:#e8f5e9; border:0.5px solid #c8e6c9; font-size:13px;">
                            ...
                            <span style="color:#1a2e1a;"> La mora acumulada se congela en ${{ number_format($prestamo->mora_acumulada, 2) }} y el préstamo vuelve a estado activo con el nuevo calendario de pagos.</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-12" id="opcion_nuevo_prestamo" style="display:none;">
            <div class="bg-white border rounded-3 p-4" style="border-color:#e8e8e8 !important;">
                ...
                <div class="row g-3">
                    <div class="col-md-3">
                        ...
                        <select name="nuevo_tipo" class="form-control form-control-sm">
                            <option value="plazo" {{ $prestamo->tipo === 'plazo' ? 'selected' : '' }}>Plazo</option>
                            <option value="interes" {{ $prestamo->tipo === 'interes' ? 'selected' : '' }}>Interés</option>
                        </select>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group input-group-sm">
                            <input type="number" step="0.01" name="nuevo_interes"
                                   value="{{ $prestamo->interes_rate }}"
                                   class="form-control form-control-sm">
                            <span class="input-group-text">%</span>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" name="nuevo_periodos"
                               value="{{ $prestamo->numero_periodos }}"
                ...
                <div class="row g-3">
                    <div class="col-12">
                        ...
                        <textarea name="motivo" rows="2" class="form-control form-control-sm @error('motivo') is-invalid @enderror"
                                  placeholder="Ej: Cliente perdió su empleo, acuerdo de pago voluntario...">{{ old('motivo') }}</textarea>
...
<script>
const moraAcumulada = {{ $prestamo->mora_acumulada }};

function mostrarOpcion(tipo) {
    ['condonacion', 'extension', 'nuevo_prestamo'].forEach(t => {
...
function calcularCondonacion() {
    const pct = parseFloat(document.getElementById('porcentaje_condonacion').value) || 0;
