...
@if(!$prestamos->total())
    <div class="bg-white border rounded-3 p-5 text-center" style="border-color:#e8e8e8 !important;">
        ...
        <p class="text-muted mb-0" style="font-size:13px;">Los préstamos reestructurados pagados aparecerán aquí.</p>
    </div>
@else
                        ...
                        <tr style="border-top:0.5px solid #f0f0f0;">
                            ...
                            <td class="px-4 py-3">
                                <div class="d-flex gap-2">
                                    ...
                                    @endforeach
                                    <a href="{{ route('historial.show', $prestamo) }}" target="_blank"
