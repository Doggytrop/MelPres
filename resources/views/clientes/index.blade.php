    ...
    <table class="table mb-0" style="font-size:14px;">
        <thead style="background:#f8f9f8; border-bottom: 1px solid #e8e8e8;">
            <tr>
                ...
                <th class="px-4 py-3 fw-medium text-muted" style="font-size:11px; text-transform:uppercase; letter-spacing:.05em;">DUI</th>
                <th class="px-4 py-3 fw-medium text-muted" style="font-size:11px; text-transform:uppercase; letter-spacing:.05em;">Teléfono</th>
        ...
        <tbody>
            @forelse($clientes as $cliente)
                <tr style="border-top: 0.5px solid #f0f0f0;">
                    ...
                    <td class="px-4 py-3 text-muted">{{ $cliente->dui ?? '—' }}</td>
                    <td class="px-4 py-3 text-muted">{{ $cliente->telefono ?? '—' }}</td>
                    <td class="px-4 py-3">
                        @php
