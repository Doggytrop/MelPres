...
class RestructuringsRecordedByTenantForeignKeyTest extends TestCase
{
    ...
    public function test_valid_restructuring_recorded_by_same_company_is_accepted(): void
    {
    ...
    public function test_restructuring_recorded_by_another_company_is_rejected(): void
    {
        ...
        $this->insertRestructuring($companyId, $loanId, $otherUserId);
    }
    ...
    public function test_rollback_removes_only_recorded_by_composite_foreign_key(): void
    {
        $migration = require database_path(
            'migrations/2026_07_21_000016_add_restructurings_recorded_by_tenant_foreign_key.php'
        );
        ...
        $this->assertNotNull(
            $this->foreignKey('restructurings_recorded_by_foreign')
        );
        $this->assertNotNull(
            $this->foreignKey('restruct_original_loan_tenant_fk')
        );
        $this->assertNotNull(
            $this->namedIndex('restructurings', 'restruct_company_recorded_idx')
        );
        $this->assertNotNull(
